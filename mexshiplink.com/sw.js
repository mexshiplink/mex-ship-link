(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["mexshiplink\\\\.com(?:/.*)?/ola/services/.*","mexshiplink\\\\.com/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://f1b33949-8062-4394-92a3-db6ec9759464\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["mexshiplink\\\\.com(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/f1b33949-8062-4394-92a3-db6ec9759464/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/f1b33949-8062-4394-92a3-db6ec9759464/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/english-us","/planes","/espa%C3%B1ol-mx","/plans-1"]').map((e => ({
                url: e,
                revision: "1682540652550"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("mexshiplink.com-"))).map((e => caches.delete(e))))
            })))
